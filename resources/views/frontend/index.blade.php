...
<head>
    ...
    <!--====== Title ======-->
    <title>Rekrutmen Tenaga Kerja Politeknik Bhakti Semesta</title>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{ asset('assets/images/mini.png') }}" alt="Logo">
                            </a>
                            ...
                            <div class="navbar-social d-none d-sm-flex align-items-center">
                                <span>FOLLOW US</span>
                                <ul>
                                    <li><a href="https://www.facebook.com/PoliteknikBhaktiSemesta"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="https://www.instagram.com/PoliteknikBhaktiSemesta/"><i class="lni-instagram-original"></i></a></li>
                                    <li><a href="https://www.youtube.com/@PoliteknikBhaktiSemesta"><i class="lni-youtube-original"></i></a></li>
                                    <li><a href="https://www.linkedin.com/company/politeknik-bhakti-semesta/mycompany/"><i class="lni-linkedin-original"></i></a></li>                                  
                                </ul>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10">
                        <div class="header-content text-center">
                            <h3 class="header-title">Sistem Rekrutmen Tenaga Kerja Politeknik Bhakti Semesta</h3>
                            <p class="text">Menyelenggarakan rekrutmen tenaga kerja Politeknik Bhakti Semesta dengan cepat, efektif dan transparan.
                            </p>
                            <ul class="header-btn">
                                <li><a class="main-btn btn-one" href="{{ url('/login') }}">DAFTAR</a></li>
                                <li><a class="main-btn btn-two video-popup" href="https://www.youtube.com/watch?v=32CCfYQtqpc">LIHAT TUTORIAL<i class="lni-play"></i></a></li>
                            </ul>
                        </div> <!-- header content -->
                    </div>
                </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-10">
                        ...
                        <p class="text">Politenik Bhakti Semesta (POLIBEST) Kota Salatiga membuka rekrutmen tenaga kerja untuk bergabung dengan Politeknik Bhakti Semesta syarat sebagai berikut.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="services-content mt-40 d-sm-flex">
                                ...
                                <div class="services-content media-body">
                                    ...
                                    <p class="text">Berdomisili di sekitar wilayah kampus Politeknik Bhakti Semesta</br> (ditunjukkan dengan bukti KTP)</p>
                                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        ...
                        <p class="text">Berikut ini beberapa persyaratan calon tenaga kerja yang wajib dipenuhi ketika melamar ke Politeknik Bhakti Semesta</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        ...
                        <div class="pricing-list">
                            <ul>
                                <li><i class="lni-check-mark-circle"></i> Berdomisili di Bumi</li>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-6">
                    <div class="call-action-content text-center">
                        ...
                        <p class="text">                    Penilaian terhadap sistem yang digunakan pada rekrutmen tenaga kerja diharapkan dapat menjadi evaluasi kedepannya</p>
                        <div class="call-newsletter">
                            <i class="lni-envelope"></i>
                            <input type="text" placeholder="rekrutmen@bhaktisemesta.ac.id">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-10">
                        ...
                        <p class="text">Silahkan ajukan pertanyaan yang anda inginkan melalui form dibawah ini terkait rekrutmen yang diadakan oleh Politeknik Bhakti Semesta</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p class="text">Hak Cipta © 2023 POLITEKNIK BHAKTI SEMESTA (POLIBEST)</a></p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
