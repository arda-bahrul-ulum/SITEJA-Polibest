<x-app-layout>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-info-circle-fill"></i> Edit Berita</h1>
                ...
                <form method="POST" action="{{ route('data_profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="pekerjaan" name="pekerjaan" class="form-control">
                                        ...
                                        <option value="Dosen" {{ $user->pekerjaan === 'Dosen' ? 'selected' : '' }}>Dosen</option>
                                        <option value="Praktisi" {{ $user->pekerjaan === 'Praktisi' ? 'selected' : '' }}>Praktisi</option>
                    ...
                    <div class="tab" id="tab-2" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="checkbox" id="dosen" name="pengalaman[]" value="Dosen"
                                    {{ in_array('dosen', old('pengalaman', explode(',', $user->pengalaman))) ?
                                'checked' : '' }}>
                                <label for="dosen">Dosen</label>
                            </div>
                            <div>
                                <input type="checkbox" id="praktisi" name="pengalaman[]"
                                    value="Praktisi" {{ in_array('Praktisi', old('pengalaman',
                                    explode(',', $user->pengalaman))) ? 'checked' : '' }}>
                                <label for="praktisi">Praktisi</label>
                            </div>
                            <div>
                                <input type="checkbox" id="wirausaha" name="pengalaman[]" value="Wirausaha" {{
                                    in_array('Wirausaha', old('pengalaman', explode(',', $user->pengalaman))) ?
                                'checked' : '' }}>
                                <label for="wirausaha">Wirausaha</label>
                            </div>
                            <div>
                                <input type="checkbox" id="karyawan_swasta" name="pengalaman[]" value="Susenas" {{
                                    in_array('Karyawan', old('pengalaman', explode(',', $user->pengalaman))) ? 'checked'
                                : '' }}>
