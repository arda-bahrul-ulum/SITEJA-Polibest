<x-app-layout>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-journal-bookmark-fill"></i> Form Pendaftaran Calon Tenaga Kerja
            </h1>
    ...
    <script>
        ...
        fetch(`https://lzddb.github.io/api-wilayah-indonesia/api/provinces.json`)
    ...
    <script>
        ...
        selectProvinsi.addEventListener('change', (e) => {
            ...
            fetch(`https://lzddb.github.io/api-wilayah-indonesia/api/regencies/${provinsi}.json`)
                .then((response) => response.json())
                .then((regencies) => {
                    var data = regencies;
        ...
        selectKota.addEventListener('change', (e) => {
            ...
            fetch(`https://lzddb.github.io/api-wilayah-indonesia/api/districts/${kota}.json`)
                .then((response) => response.json())
                .then((districts) => {
                    var data = districts;
